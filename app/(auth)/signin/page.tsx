      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1">Welcome to E-Mechanics. Where Service Meets Opportunity.</h1>
          </div>
          ...
          <div className="max-w-sm mx-auto">
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <div className="flex justify-between">
                    ...
                    <Link href="/reset-password" className="text-purple-600 hover:text-blue-400 transition duration-150 ease-in-out">
                      Forgot Password?
                    </Link>
                  </div>
                </div>
            ...
            <div className="text-gray-600 text-center mt-6">
              ...
              <Link href="/signup" className="text-purple-600 hover:text-purple-800 transition duration-150 ease-in-out">
                Sign up
              </Link>
            </div>
          </div>
